...
// Setting WiFi
char ssid[] = "a";
char pass[] = "aji1234567890aa";

// Setting Server
//  char SocketServer[] = "192.168.43.47";
char SocketServer[] = "192.168.43.163";
int port = 4000;
...
void handleSensor()
{
  ...
  // WaterLv();
  TdsSensor();
  String data = "{\"Temperature\":\"" + String(random(27, 30)) + "\", \"Humidity\":\"" + String(random(66, 100)) + "\", \"Tds\":\"" + String("1000") + "\", \"WL\":\"" + String(kalibrasiWl(float(random(1, 100)))) + "\"}";
...
void setup()
{
  ...
  server.on("/readSensor", handleSensor); // This page is called by java Script AJAX
...
void loop()
{
  ...
  if (IsConnect && WiFi.status() == WL_CONNECTED)
  {
    ...
    KirimSocket("hum", String(random(66, 100)));
  ...
  {
    //    print nilai sensor langsung tanpa menggunakan fungsi KirimSocket
    Serial.print("temperatur: ");
    // Serial.println(t);
    Serial.println(String(random(27, 30)));
    Serial.print("kelembaban: ");
    // Serial.println(h);
    Serial.println(String(random(66, 100)));
    Serial.print("Tds : ");
    // Serial.println(tdsVal);
    Serial.println("1000");
    Serial.print("water level: ");
    // Serial.println(kalibrasiWl(distance));
    Serial.println(kalibrasiWl(float(random(1, 100))));
  }
  delay(1500);
}
